...
(function() {
  ...
  window.Emitter = Class.create({
    ...
    alignCanvas: function() {
      ...
      this.canvas.setStyle('z-index:99; position:absolute; top:' + (this.inputOffset[1]-150+15) + 'px; left: ' + (this.inputOffset[0]-(75-this.inputDim.width/2)) + 'px;');    
      this.input.setStyle('position:relative; z-index:100');
